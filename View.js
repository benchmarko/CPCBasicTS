...
var View = /** @class */ (function () {
    ...
    View.prototype.setHidden = function (id, hidden, display) {
        ...
        var element = View.getElementById1(id), displayVisible = "display" + Utils.stringCapitalize(display || "block");
        if (hidden) {
    ...
    View.prototype.fnDownloadBlob = function (data, filename) {
        ...
        var data8 = Utils.string2Uint8Array(data), type = "octet/stream", blob = new Blob([data8.buffer], {
            type: type
        });
