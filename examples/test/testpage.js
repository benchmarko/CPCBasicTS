...
1962 DEF FNf1(o,v,t)=o+v+t
1963 a=FNf1(1,2,3):IF a<>6 THEN ERROR 33
1968 '
1969 PRINT"DEFINT, DEFREAL, DEFSTR"
1970 i=0:i!=2:i%=3.5:i$="i"
1971 if i<>2 THEN ERROR 33
1972 if i%<>4 THEN ERROR 33
1973 defint i
1974 if i<>4 THEN ERROR 33
1975 if i!<>2 THEN ERROR 33
1976 if i%<>4 THEN ERROR 33
1977 if i$<>"i" THEN ERROR 33
1978 i=1.25:IF i<>1 THEN ERROR 33
1979 IF i%<>1 THEN ERROR 33
1980 DEFREAL i
1981 if i<>2 THEN ERROR 33
1982 IF i%<>1 THEN ERROR 33
1983 if i!<>2 THEN ERROR 33
1984 if i$<>"i" THEN ERROR 33
1985 i=1.2
1986 if i<>1.2 THEN ERROR 33
1987 if i!<>1.2 THEN ERROR 33
1988 if i%<>1 THEN ERROR 33
1989 DEFSTR i
1990 if i<>"i" THEN ERROR 33
1991 IF i%<>1 THEN ERROR 33
1992 if i!<>1.2 THEN ERROR 33
1993 if i$<>"i" THEN ERROR 33
1994 i="j"
1995 if i$<>"j" THEN ERROR 33
1996 DEFINT i
1997 PRINT"DIM"
1998 dim m(0)
2000 m(0)=2
