...
790 '
800 y=399-VPOS(#0)*16:PRINT "x";:MOVE 0,y,,1:TAG:PRINT "A";:MOVE 0,y:PRINT "A";:TAGOFF:MOVE 0,0,,0:PRINT "#";
810 GOSUB 9010:IF a$<>"x#" THEN ERROR 33
820 y=399-VPOS(#0)*16:PRINT "y";CHR$(23)"1";:MOVE 0,y:TAG:PRINT "B";:MOVE 0,y:PRINT "B";:TAGOFF:PRINT CHR$(23)"0";:PRINT "#";
830 GOSUB 9010:IF a$<>"y#" THEN ERROR 33
840 y=399-VPOS(#0)*16:PRINT "z";:CALL &BC59,1:MOVE 0,y:TAG:PRINT "C";:MOVE 0,y:PRINT "C";:TAGOFF:CALL &BC59:PRINT "#";
850 GOSUB 9010:IF a$<>"z#" THEN ERROR 33
860 PLOT 0,0,1:PLOT 0,0,1:IF TEST(0,0)<>1 THEN ERROR 33
1000 '
