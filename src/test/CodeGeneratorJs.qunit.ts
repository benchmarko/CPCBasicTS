...
QUnit.module("CodeGeneratorJs: Tests", function () {
	const allTests: AllTestsType = { // eslint-disable-line vars-on-top
		...
		"call, cat, chain, chain merge, chr$, cint, clg, closein, closeout, cls, cont, copychr$, cos, creal, cursor": {
			"call&a7bc": ' o.call(0xa7bc); o.goto("s0"); break;\ncase "s0":',
		...
		"left$, len, let, line input, list, load, locate, log, log10, lower$": {
			...
			'load "file.scr",&c000': ' o.load("file.scr", 0xc000); o.goto("s0"); break;\ncase "s0":',
		...
		save: {
			...
			'save "file.scr",b,&c000,&4000': ' o.save("file.scr", "b", 0xc000, 0x4000); o.goto("s0"); break;\ncase "s0":',
			'save "file.bin",b,&8000,&100,&8010': ' o.save("file.bin", "b", 0x8000, 0x100, 0x8010); o.goto("s0"); break;\ncase "s0":',
