...
QUnit.module("CodeGeneratorJs: Tests", function (/* hooks */) {
	const mAllTests = {
		...
		"call, cat, chain, chain merge, chr$, cint, clg, closein, closeout, cls, cont, copychr$, cos, creal, cursor": {
			...
			"chain merge \"f5\" , , delete 100-200": " o.chainMerge(\"f5\", null, 100, 200); o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":",
		...
		"data, dec$, def fn, defint, defreal, defstr, deg, delete, derr, di, dim, draw, drawr": {
			...
			"deg ": " o.deg();",
			"delete": " o.delete(); break;",
			"delete 10": " o.delete(10); break;",
			"delete 1-": " o.delete(1, null); break;",
			"delete -1": " o.delete(null, 1); break;",
			...
			"draw 10,20,,3": " o.draw(10, 20, null, 3);",
			...
			"drawr 10,20,,3": " o.drawr(10, 20, null, 3);",
		...
		"edit, ei, else, end, ent, env, eof, erase, erl, err, error, every gosub, exp": {
			...
			"ent num,=period,ti,=period2,ti2": " o.ent(v.num, null, v.period, v.ti, null, v.period2, v.ti2);",
			"env 1": " o.env(1);",
			"env 1,2,a,4": " o.env(1, 2, v.a, 4);",
			"env num,steps,dist,ti,steps2,dist2,ti2": " o.env(v.num, v.steps, v.dist, v.ti, v.steps2, v.dist2, v.ti2);",
			"env num,=reg,period,=reg2,period2": " o.env(v.num, null, v.reg, v.period, null, v.reg2, v.period2);",
			...
			"10 every 50 gosub 10": " o.everyGosub(50, null, 10);",
		...
		"gosub, goto, graphics paper, graphics pen": {
			...
			"graphics pen ,0": " o.graphicsPen(null, 0);",
		...
		"if, ink, inkey, inkey$, inp, input, instr, int": {
			...
			"input a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, null, \"? \", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			"input a$,b": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, null, \"? \", \"a$\", \"b\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();",
			"input ;a$,b": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, \";\", \"? \", \"a$\", \"b\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();",
			"input \"para\",a$,b": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, null, \"para\", \"a$\", \"b\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();",
			"input \"para\";a$,b": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, null, \"para? \", \"a$\", \"b\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();",
			"input ;\"para noCRLF\";a$,b": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.input(null, \";\", \"para noCRLF? \", \"a$\", \"b\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();",
		...
		"left$, len, , line input, list, load, locate, log, log10, lower$": {
			...
			"line input a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.lineInput(null, null, \"? \", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			"line input ;a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.lineInput(null, \";\", \"? \", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			"line input \"para\",a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.lineInput(null, null, \"para\", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			"line input \"para\";a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.lineInput(null, null, \"para? \", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			"line input ;\"para noCRLF\";a$": " o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":o.lineInput(null, \";\", \"para noCRLF? \", \"a$\"); o.goto(\"NaNs1\"); break;\ncase \"NaNs1\":; v.a$ = o.vmGetNextInput();",
			...
			"list ": " o.list(); break;",
			"list 10": " o.list(null, 10); break;",
			"list 1-": " o.list(null, 1, null); break;",
			"list -1": " o.list(null, null, 1); break;",
			"list 1-2": " o.list(null, 1, 2); break;",
			"list #3": " o.list(3, null); break;",
			"list ,#3": " o.list(3, null); break;",
			"list 10,#3": " o.list(3, 10); break;",
			"list 1-,#3": " o.list(3, 1, null); break;",
			"list -1,#3": " o.list(3, null, 1); break;",
			...
			"locate 10,20": " o.locate(null, 10, 20);",
		...
		"mask, max, memory, merge, mid$, min, mod, mode, move, mover": {
			...
			"move 10,20,,3": " o.move(10, 20, null, 3);",
			...
			"mover 10,20,,3": " o.mover(10, 20, null, 3);",
		...
		"paper, peek, pen, pi, plot, plotr, poke, pos, print": {
			...
			"plot 10,20,,3": " o.plot(10, 20, null, 3);",
			...
			"plotr 10,20,,3": " o.plotr(10, 20, null, 3);",
			...
			"print ": " o.print(null, \"\\r\\n\");",
			"print \"string\"": " o.print(null, \"string\", \"\\r\\n\");",
			"print a$": " o.print(null, v.a$, \"\\r\\n\");",
		...
		save: {
			...
			"sound ch,period,duration,,,,noise": " o.sound(v.ch, v.period, v.duration, null, null, null, v.noise); o.goto(\"NaNs0\"); break;\ncase \"NaNs0\":",
		...
		"wait, wend, while, width, window, window swap, write": {
			...
			"width 40": " o.width(40);",
			"window 10,30,5,20": " o.window(null, 10, 30, 5, 20);",
			...
			"write a$": " o.write(null, v.a$);",
			"write a$,b": " o.write(null, v.a$, v.b);",
		...
		for (const sKey in oTests) {
			if (oTests.hasOwnProperty(sKey)) {
				...
				const oVariables = new Variables(),
					oOutput = oCodeGeneratorJs.generate(sKey, oVariables, true),
