...
var VirtualKeyboard = /** @class */ (function () {
    ...
    VirtualKeyboard.prototype.createButtonRow = function (id, options) {
        var place = View.getElementById1(id);
    ...
    VirtualKeyboard.prototype.virtualKeyboardCreatePart = function (id, virtualKeyboard) {
        var keyArea = View.getElementById1(id), shiftLock = this.shiftLock, numLock = this.numLock, cpcKey2Key = VirtualKeyboard.cpcKey2Key, buttons = keyArea.getElementsByTagName("button");
    ...
    VirtualKeyboard.prototype.virtualKeyboardAdaptKeys = function (shiftLock, numLock) {
        var keyArea = View.getElementById1("kbdAreaInner" /* ViewID.kbdAreaInner */), buttons = keyArea.getElementsByTagName("button"); // or: keyArea.childNodes and filter
    ...
    VirtualKeyboard.prototype.onVirtualKeyboardKeydown = function (event) {
        var node = View.getEventTarget(event), cpcKey = node.getAttribute("data-key");
        if (Utils.debug > 1) {
    ...
    VirtualKeyboard.prototype.onVirtualKeyboardKeyupOrKeyout = function (event) {
        var node = View.getEventTarget(event);
        if (Utils.debug > 1) {
