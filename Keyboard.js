    ...
    var Keyboard = /** @class */ (function () {
        ...
        Keyboard.prototype.fnKeyboardKeydown = function (event) {
            ...
            if (pressedKey in this.key2CpcKey) {
                ...
                if (Utils_1.Utils.debug > 1) {
                    Utils_1.Utils.console.log("fnKeyboardKeydown: simulatedNumLock=" + this.simulatedNumLock);
                }
            }
            else {
        ...
        Keyboard.prototype.fnKeyboardKeyup = function (event) {
            ...
            if (pressedKey in this.key2CpcKey) {
                ...
                if (Utils_1.Utils.debug > 1) {
                    Utils_1.Utils.console.log("fnKeyboardKeyup: simulatedNumLock=" + this.simulatedNumLock);
                }
            }
            else {
