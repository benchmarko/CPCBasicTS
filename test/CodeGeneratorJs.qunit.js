    ...
    QUnit.module("CodeGeneratorJs: Tests", function () {
        var allTests = {
            ...
            special: {
                ...
                "|": ' o.rsx.rsxExec(""); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "call, cat, chain, chain merge, chr$, cint, clg, closein, closeout, cls, cont, copychr$, cos, creal, cursor": {
                "call&a7bc": ' o.call(-0x5844); o.vmGoto("s0"); break;\ncase "s0":',
                "call 4711,1,2,3,4": ' o.call(4711, 1, 2, 3, 4); o.vmGoto("s0"); break;\ncase "s0":',
                "cat ": " o.cat();",
                'chain"f1"': ' o.chain("f1"); o.vmGoto("s0"); break;\ncase "s0":',
                'chain"f2" , 10': ' o.chain("f2", 10); o.vmGoto("s0"); break;\ncase "s0":',
                'chain"f3" , 10+3': ' o.chain("f3", 10 + 3); o.vmGoto("s0"); break;\ncase "s0":',
                'chain "f4" , 10+3, delete 100-200': ' o.chain("f4", 10 + 3, 100, 200); o.vmGoto("s0"); break;\ncase "s0":',
                'chain "f5" , , delete 100-200': ' o.chain("f5", undefined, 100, 200); o.vmGoto("s0"); break;\ncase "s0":',
                'chain merge "f1"': ' o.chainMerge("f1"); o.vmGoto("s0"); break;\ncase "s0":',
                'chain merge "f2" , 10': ' o.chainMerge("f2", 10); o.vmGoto("s0"); break;\ncase "s0":',
                'chain merge "f3" , 10+3': ' o.chainMerge("f3", 10 + 3); o.vmGoto("s0"); break;\ncase "s0":',
                'chain merge "f4" , 10+3, delete 100-200': ' o.chainMerge("f4", 10 + 3, 100, 200); o.vmGoto("s0"); break;\ncase "s0":',
                'chain merge "f5" , , delete 100-200': ' o.chainMerge("f5", undefined, 100, 200); o.vmGoto("s0"); break;\ncase "s0":',
                "a=chr$(65)": "CodeGeneratorJs: Type error in  at pos 1-2: =",
                "a=cint(2.3)": " v.aR = o.cint(2.3);",
                "clear ": ' o.clear(); o.vmGoto("s0"); break;\ncase "s0":',
                "clear input": " o.clearInput();",
                "clg ": " o.clg();",
                "clg 15-1": " o.clg(15 - 1);",
                "closein ": " o.closein();",
                "closeout ": ' o.closeout(); o.vmGoto("s0"); break;\ncase "s0":',
                "cls ": " o.cls(0);",
                "cls #5": " o.cls(5);",
            ...
            "fill, fix, fn, for, frame, fre": {
                ...
                "for a=1 to 10": ' /* for() */ v.aR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 1;\ncase "f0b": if (v.aR > 10) { o.vmGoto("f0e"); break; }',
                "for a%=1.5 to 9.5": ' /* for() */ v.aI = o.vmAssign("aI", 1.5); v.aIEnd = o.vmAssign("aI", 9.5); o.vmGoto("f0b"); break;\ncase "f0": v.aI += 1;\ncase "f0b": if (v.aI > v.aIEnd) { o.vmGoto("f0e"); break; }',
                "for a!=1.5 to 9.5": ' /* for() */ v.aR = o.vmAssign("aR", 1.5); v.aREnd = o.vmAssign("aR", 9.5); o.vmGoto("f0b"); break;\ncase "f0": v.aR += 1;\ncase "f0b": if (v.aR > v.aREnd) { o.vmGoto("f0e"); break; }',
                "for a=1 to 10 step 3": ' /* for() */ v.aR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 3;\ncase "f0b": if (v.aR > 10) { o.vmGoto("f0e"); break; }',
                "for a=5+b to -4 step -2.3": ' /* for() */ v.aR = o.vmAssign("aR", 5 + v.bR); v.aRStep = o.vmAssign("aR", -2.3); o.vmGoto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > -4 || v.aRStep < 0 && v.aR < -4 || !v.aRStep && v.aR === -4) { o.vmGoto("f0e"); break; }',
                "for a=b to c step d": ' /* for() */ v.aR = o.vmAssign("aR", v.bR); v.aREnd = o.vmAssign("aR", v.cR); v.aRStep = o.vmAssign("aR", v.dR); o.vmGoto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > v.aREnd || v.aRStep < 0 && v.aR < v.aREnd || !v.aRStep && v.aR === v.aREnd) { o.vmGoto("f0e"); break; }',
                "for a=b% to c%": ' /* for() */ v.aR = v.bI; v.aREnd = v.cI; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 1;\ncase "f0b": if (v.aR > v.aREnd) { o.vmGoto("f0e"); break; }',
                "for a=1 to 1 step 0": ' /* for() */ v.aR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === 1) { o.vmGoto("f0e"); break; }',
                "for a=b to c step s": ' /* for() */ v.aR = o.vmAssign("aR", v.bR); v.aREnd = o.vmAssign("aR", v.cR); v.aRStep = o.vmAssign("aR", v.sR); o.vmGoto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > v.aREnd || v.aRStep < 0 && v.aR < v.aREnd || !v.aRStep && v.aR === v.aREnd) { o.vmGoto("f0e"); break; }',
                "for a=1 to 2 step 0": ' /* for() */ v.aR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === 2) { o.vmGoto("f0e"); break; }',
                "for a=-1 to -2 step 0": ' /* for() */ v.aR = -1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === -2) { o.vmGoto("f0e"); break; }',
                "1 for a$=1 to 2": "CodeGeneratorJs: Type error in 1 at pos 6-8: a$",
                "defint a:for abc=1 to 10 step 3:next abc": ' o.defint("a"); /* for() */ o.vmAssertNumberType("a"); v["abc" + t.a] = 1; o.vmGoto("f0b"); break;\ncase "f0": v["abc" + t.a] += 3;\ncase "f0b": if (v["abc" + t.a] > 10) { o.vmGoto("f0e"); break; } /* next("v["abc" + t.a]") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "defstr a:for abc=1 to 10 step 3:next abc": ' o.defstr("a"); /* for() */ o.vmAssertNumberType("a"); v["abc" + t.a] = 1; o.vmGoto("f0b"); break;\ncase "f0": v["abc" + t.a] += 3;\ncase "f0b": if (v["abc" + t.a] > 10) { o.vmGoto("f0e"); break; } /* next("v["abc" + t.a]") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "for a=b to c step s:defint a-b:a=0:defreal a:next": ' /* for() */ o.vmAssertNumberType("a"); v["a" + t.a] = o.vmAssign("a", v["b" + t.b]); v.aEnd = o.vmAssign("a", v.cR); v.aStep = o.vmAssign("a", v.sR); o.vmGoto("f0b"); break;\ncase "f0": v["a" + t.a] += v.aStep;\ncase "f0b": if (v.aStep > 0 && v["a" + t.a] > v.aEnd || v.aStep < 0 && v["a" + t.a] < v.aEnd || !v.aStep && v["a" + t.a] === v.aEnd) { o.vmGoto("f0e"); break; } o.defint("a", "b"); v["a" + t.a] = o.vmAssign("a", 0); o.defreal("a"); /* next("") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "frame ": ' o.frame(); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "if, ink, inkey, inkey$, inp, input, instr, int": {
                ...
                "input a$": ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, undefined, "? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                "input a$,b": ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, undefined, "? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                "input ;a$,b": ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, ";", "? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                'input "para",a$,b': ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, undefined, "para", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                'input "para";a$,b': ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, undefined, "para? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                'input ;"para noCRLF";a$,b': ' o.vmGoto("s0"); break;\ncase "s0":o.input(0, ";", "para noCRLF? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                'input#2,;"para noCRLF";a$,b': ' o.vmGoto("s0"); break;\ncase "s0":o.input(2, ";", "para noCRLF? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
                'input#stream,;"string";a$,b': ' o.vmGoto("s0"); break;\ncase "s0":o.input(v.streamR, ";", "string? ", "a$", "bR"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.bR = o.vmGetNextInput();',
            ...
            "left$, len, let, line input, list, load, locate, log, log10, lower$": {
                ...
                "line input a$": ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(0, undefined, "? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                "line input ;a$": ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(0, ";", "? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                'line input "para",a$': ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(0, undefined, "para", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                'line input "para";a$': ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(0, undefined, "para? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                'line input ;"para noCRLF";a$': ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(0, ";", "para noCRLF? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                'line input#2,;"para noCRLF";a$': ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(2, ";", "para noCRLF? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                'line input#stream,;"string";a$': ' o.vmGoto("s0"); break;\ncase "s0":o.lineInput(v.streamR, ";", "string? ", "a$"); o.vmGoto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                "list ": " o.list(0); break;",
                ...
                'load "file"': ' o.load("file"); o.vmGoto("s0"); break;\ncase "s0":',
                'load "file.scr",&c000': ' o.load("file.scr", -0x4000); o.vmGoto("s0"); break;\ncase "s0":',
                "load f$,adr": ' o.load(v.f$, v.adrR); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "mask, max, memory, merge, mid$, min, mod, mode, move, mover": {
                ...
                'merge "file"': ' o.merge("file"); o.vmGoto("s0"); break;\ncase "s0":',
                "merge f$": ' o.merge(v.f$); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "new, next, not": {
                "new ": " o.new();",
                "for a=1 to 2: next ": ' /* for() */ v.aR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.aR += 1;\ncase "f0b": if (v.aR > 2) { o.vmGoto("f0e"); break; } /* next("") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "for i=1 to 2: next i": ' /* for() */ v.iR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.iR += 1;\ncase "f0b": if (v.iR > 2) { o.vmGoto("f0e"); break; } /* next("v.iR") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "for j=1 to 2:for i=3 to 4: next i,j": ' /* for() */ v.jR = 1; o.vmGoto("f0b"); break;\ncase "f0": v.jR += 1;\ncase "f0b": if (v.jR > 2) { o.vmGoto("f0e"); break; } /* for() */ v.iR = 3; o.vmGoto("f1b"); break;\ncase "f1": v.iR += 1;\ncase "f1b": if (v.iR > 4) { o.vmGoto("f1e"); break; } /* next("v.iR") */ o.vmGoto("f1"); break;\ncase "f1e":; /* next("v.jR") */ o.vmGoto("f0"); break;\ncase "f0e":',
                "a=not 2": " v.aR = ~(2);",
            ...
            "on break ..., on error goto, on gosub, on goto, on sq gosub, openin, openout, or, origin, out": {
                ...
                'openin "file"': ' o.openin("file"); o.vmGoto("s0"); break;\ncase "s0":',
                "openin f$": ' o.openin(v.f$); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "rad, randomize, read, release, rem, remain, renum, restore, resume, return, right$, rnd, round, run": {
                "rad ": " o.rad();",
                "randomize ": ' o.vmGoto("s0"); break;\ncase "s0":o.randomize(); o.vmGoto("s1"); break;\ncase "s1": o.randomize(o.vmGetNextInput());',
                ...
                "renum ": ' o.renum(); o.vmGoto("s0"); break;\ncase "s0":',
                "renum 100": ' o.renum(100); o.vmGoto("s0"); break;\ncase "s0":',
                "renum 100,50": ' o.renum(100, 50); o.vmGoto("s0"); break;\ncase "s0":',
                "renum 100,50,2": ' o.renum(100, 50, 2); o.vmGoto("s0"); break;\ncase "s0":',
                "restore ": " o.restore();",
                ...
                "run ": ' o.run(); o.vmGoto("s0"); break;\ncase "s0":',
                "10 run 10": ' o.run(10); o.vmGoto("10s0"); break;\ncase "10s0":',
                'run "file"': ' o.run("file"); o.vmGoto("s0"); break;\ncase "s0":',
                "run f$": ' o.run(v.f$); o.vmGoto("s0"); break;\ncase "s0":'
            },
            save: {
                'save "file"': ' o.save("file"); o.vmGoto("s0"); break;\ncase "s0":',
                'save "file",p': ' o.save("file", "p"); o.vmGoto("s0"); break;\ncase "s0":',
                'save "file",a': ' o.save("file", "a"); o.vmGoto("s0"); break;\ncase "s0":',
                'save "file.scr",b,&c000,&4000': ' o.save("file.scr", "b", -0x4000, 0x4000); o.vmGoto("s0"); break;\ncase "s0":',
                'save "file.bin",b,&8000,&100,&8010': ' o.save("file.bin", "b", -0x8000, 0x100, -0x7ff0); o.vmGoto("s0"); break;\ncase "s0":',
                "save f$,b,adr,lg,entry": ' o.save(v.f$, "b", v.adrR, v.lgR, v.entryR); o.vmGoto("s0"); break;\ncase "s0":',
                "a=sgn(5)": " v.aR = o.sgn(5);",
                "a=sgn(0)": " v.aR = o.sgn(0);",
                "a=sgn(-5)": " v.aR = o.sgn(-5);",
                "a=sin(2.3)": " v.aR = o.sin(2.3);",
                "sound 1,100": ' o.sound(1, 100); o.vmGoto("s0"); break;\ncase "s0":',
                "sound 1,100,400": ' o.sound(1, 100, 400); o.vmGoto("s0"); break;\ncase "s0":',
                "sound 1,100,400,15": ' o.sound(1, 100, 400, 15); o.vmGoto("s0"); break;\ncase "s0":',
                "sound 1,100,400,15,1": ' o.sound(1, 100, 400, 15, 1); o.vmGoto("s0"); break;\ncase "s0":',
                "sound 1,100,400,15,1,1": ' o.sound(1, 100, 400, 15, 1, 1); o.vmGoto("s0"); break;\ncase "s0":',
                "sound 1,100,400,15,1,1,4": ' o.sound(1, 100, 400, 15, 1, 1, 4); o.vmGoto("s0"); break;\ncase "s0":',
                "sound ch,period,duration,,,,noise": ' o.sound(v.chR, v.periodR, v.durationR, undefined, undefined, undefined, v.noiseR); o.vmGoto("s0"); break;\ncase "s0":',
                "sound ch,period,duration,vol,env1,ent1,noise": ' o.sound(v.chR, v.periodR, v.durationR, v.volR, v.env1R, v.ent1R, v.noiseR); o.vmGoto("s0"); break;\ncase "s0":',
            ...
            "wait, wend, while, width, window, window swap, write": {
                ...
                "while a=10: wend ": ' \ncase "w0": if (!(v.aR === 10 ? -1 : 0)) { o.vmGoto("w0e"); break; } /* o.wend() */ o.vmGoto("w0"); break;\ncase "w0e":',
                "while a>0": ' \ncase "w0": if (!(v.aR > 0 ? -1 : 0)) { o.vmGoto("w0e"); break; }',
                "width 40": " o.width(40);",
            ...
            rsx: {
                "|a": ' o.rsx.a(); o.vmGoto("s0"); break;\ncase "s0":',
                "|b": ' o.rsx.b(); o.vmGoto("s0"); break;\ncase "s0":',
                "|basic": ' o.rsx.basic(); o.vmGoto("s0"); break;\ncase "s0":',
                "|cpm": ' o.rsx.cpm(); o.vmGoto("s0"); break;\ncase "s0":',
                'a$="*.drw":|dir,@a$': ' v.a$ = "*.drw"; o.rsx.dir(o.addressOf("a$")); o.vmGoto("s0"); break;\ncase "s0":',
                "|disc": ' o.rsx.disc(); o.vmGoto("s0"); break;\ncase "s0":',
                "|disc.in": ' o.rsx.disc_in(); o.vmGoto("s0"); break;\ncase "s0":',
                "|disc.out": ' o.rsx.disc_out(); o.vmGoto("s0"); break;\ncase "s0":',
                "|drive,0": ' o.rsx.drive(0); o.vmGoto("s0"); break;\ncase "s0":',
                "1 |drive,": "BasicParser: Expected any parameter for , in 1 at pos 9: ",
                "1 |drive,#1": "BasicParser: Unexpected stream in 1 at pos 9-10: #",
                '|era,"file.bas"': ' o.rsx.era("file.bas"); o.vmGoto("s0"); break;\ncase "s0":',
                '|ren,"file1.bas","file2.bas"': ' o.rsx.ren("file1.bas", "file2.bas"); o.vmGoto("s0"); break;\ncase "s0":',
                "|tape": ' o.rsx.tape(); o.vmGoto("s0"); break;\ncase "s0":',
                "|tape.in": ' o.rsx.tape_in(); o.vmGoto("s0"); break;\ncase "s0":',
                "|tape.out": ' o.rsx.tape_out(); o.vmGoto("s0"); break;\ncase "s0":',
                "|user,1": ' o.rsx.user(1); o.vmGoto("s0"); break;\ncase "s0":',
                "|mode,3": ' o.rsx.mode(3); o.vmGoto("s0"); break;\ncase "s0":',
                "|renum,1,2,3,4": ' o.rsx.renum(1, 2, 3, 4); o.vmGoto("s0"); break;\ncase "s0":'
            },
            keepSpaces: {
