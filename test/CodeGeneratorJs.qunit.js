    ...
    QUnit.module("CodeGeneratorJs: Tests", function () {
        var allTests = {
            numbers: {
                ...
                "a=&A7": ' v.a = o.vmAssign("a", 167);',
                "a=-&A7": ' v.a = o.vmAssign("a", -167);',
                "a=&7FFF": ' v.a = o.vmAssign("a", 32767);',
            ...
            variables: {
                ...
                'a$="1.4"': ' v.a$ = "1.4";',
                "case=1": ' v.case = o.vmAssign("c", 1);',
                "CASE=1": ' v.case = o.vmAssign("c", 1);',
                "CaSe=cAsE": ' v.case = o.vmAssign("c", v.case);',
                "insert.line=2": ' v.insert_line = o.vmAssign("i", 2);',
                "in.ser.t.lin.e=2": ' v.in_ser_t_lin_e = o.vmAssign("i", 2);',
                "a!(2)=1.4": " v.aRA[2] = 1.4;",
                ...
                "a!(b+1)=b!(int(a),a%*2,a%-1+&d)": " v.aRA[o.vmRound(v.b + 1)] = v.bRAAA[o.int(v.a)][v.aI * 2][(v.aI - 1) + 13];",
            ...
            expressions: {
                ...
                "a=&A7+&X10100111-(123-27)": ' v.a = o.vmAssign("a", (167 + 0b10100111) - (123 - 27));',
            ...
            "call, cat, chain, chain merge, chr$, cint, clg, closein, closeout, cls, cont, copychr$, cos, creal, cursor": {
                "call&a7bc": ' o.call(-22596); o.goto("s0"); break;\ncase "s0":',
            ...
            "fill, fix, fn, for, frame, fre": {
                ...
                "for a=1 to 10": ' /* for() */ o.vmAssertNumberType("a"); v.a = 1; o.goto("f0b"); break;\ncase "f0": v.a += 1;\ncase "f0b": if (v.a > 10) { o.goto("f0e"); break; }',
                ...
                "for a=1 to 10 step 3": ' /* for() */ o.vmAssertNumberType("a"); v.a = 1; o.goto("f0b"); break;\ncase "f0": v.a += 3;\ncase "f0b": if (v.a > 10) { o.goto("f0e"); break; }',
                "for a=5+b to -4 step -2.3": ' /* for() */ o.vmAssertNumberType("a"); v.a = o.vmAssign("a", 5 + v.b); v.aStep = o.vmAssign("a", -2.3); o.goto("f0b"); break;\ncase "f0": v.a += v.aStep;\ncase "f0b": if (v.aStep > 0 && v.a > -4 || v.aStep < 0 && v.a < -4) { o.goto("f0e"); break; }',
                "for a=b to c step d": ' /* for() */ o.vmAssertNumberType("a"); v.a = o.vmAssign("a", v.b); v.aEnd = o.vmAssign("a", v.c); v.aStep = o.vmAssign("a", v.d); o.goto("f0b"); break;\ncase "f0": v.a += v.aStep;\ncase "f0b": if (v.aStep > 0 && v.a > v.aEnd || v.aStep < 0 && v.a < v.aEnd) { o.goto("f0e"); break; }',
                "for a=b% to c%": ' /* for() */ o.vmAssertNumberType("a"); v.a = v.bI; v.aEnd = v.cI; o.goto("f0b"); break;\ncase "f0": v.a += 1;\ncase "f0b": if (v.a > v.aEnd) { o.goto("f0e"); break; }',
            ...
            "if, ink, inkey, inkey$, inp, input, instr, int": {
                ...
                'input#stream,;"string";a$,b': ' o.goto("s0"); break;\ncase "s0":o.input(v.stream, ";", "string? ", "a$", "b"); o.goto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput(); v.b = o.vmGetNextInput();',
            ...
            "left$, len, let, line input, list, load, locate, log, log10, lower$": {
                ...
                'line input#stream,;"string";a$': ' o.goto("s0"); break;\ncase "s0":o.lineInput(v.stream, ";", "string? ", "a$"); o.goto("s1"); break;\ncase "s1":; v.a$ = o.vmGetNextInput();',
                "list ": " o.list(0); break;",
                ...
                'load "file.scr",&c000': ' o.load("file.scr", -16384); o.goto("s0"); break;\ncase "s0":',
                "load f$,adr": ' o.load(v.f$, v.adr); o.goto("s0"); break;\ncase "s0":',
            ...
            "new, next, not": {
                "new ": " o.new();",
                "for a=1 to 2: next ": ' /* for() */ o.vmAssertNumberType("a"); v.a = 1; o.goto("f0b"); break;\ncase "f0": v.a += 1;\ncase "f0b": if (v.a > 2) { o.goto("f0e"); break; } /* next("") */ o.goto("f0"); break;\ncase "f0e":',
                "for i=1 to 2: next i": ' /* for() */ o.vmAssertNumberType("i"); v.i = 1; o.goto("f0b"); break;\ncase "f0": v.i += 1;\ncase "f0b": if (v.i > 2) { o.goto("f0e"); break; } /* next("v.i") */ o.goto("f0"); break;\ncase "f0e":',
                "for j=1 to 2:for i=3 to 4: next i,j": ' /* for() */ o.vmAssertNumberType("j"); v.j = 1; o.goto("f0b"); break;\ncase "f0": v.j += 1;\ncase "f0b": if (v.j > 2) { o.goto("f0e"); break; } /* for() */ o.vmAssertNumberType("i"); v.i = 3; o.goto("f1b"); break;\ncase "f1": v.i += 1;\ncase "f1b": if (v.i > 4) { o.goto("f1e"); break; } /* next("v.i") */ o.goto("f1"); break;\ncase "f1e":; /* next("v.j") */ o.goto("f0"); break;\ncase "f0e":',
            ...
            "on break ..., on error goto, on gosub, on goto, on sq gosub, openin, openout, or, origin, out": {
                ...
                "a=1 or &1a0": ' v.a = o.vmAssign("a", 1 | 416);',
            ...
            save: {
                ...
                'save "file.scr",b,&c000,&4000': ' o.save("file.scr", "b", -16384, 16384); o.goto("s0"); break;\ncase "s0":',
                'save "file.bin",b,&8000,&100,&8010': ' o.save("file.bin", "b", -32768, 256, -32752); o.goto("s0"); break;\ncase "s0":',
                "save f$,b,adr,lg,entry": ' o.save(v.f$, "b", v.adr, v.lg, v.entry); o.goto("s0"); break;\ncase "s0":',
                ...
                "sound ch,period,duration,,,,noise": ' o.sound(v.ch, v.period, v.duration, undefined, undefined, undefined, v.noise); o.goto("s0"); break;\ncase "s0":',
                "sound ch,period,duration,vol,env1,ent1,noise": ' o.sound(v.ch, v.period, v.duration, v.vol, v.env1, v.ent1, v.noise); o.goto("s0"); break;\ncase "s0":',
            ...
            "unt, upper$": {
                "a=unt(&ff66)": ' v.a = o.vmAssign("a", o.unt(-154));',
            ...
            "wait, wend, while, width, window, window swap, write": {
                "wait &ff34,20": " o.wait(-204, 20);",
                "wait &ff34,20,25": " o.wait(-204, 20, 25);",
                "while a=10: wend ": ' \ncase "w0": if (!(v.a === 10 ? -1 : 0)) { o.goto("w0e"); break; } /* o.wend() */ o.goto("w0"); break;\ncase "w0e":',
                "while a>0": ' \ncase "w0": if (!(v.a > 0 ? -1 : 0)) { o.goto("w0e"); break; }',
                "width 40": " o.width(40);",
            ...
            rsx: {
                ...
                'a$="*.drw":|dir,@a$': ' v.a$ = "*.drw"; o.rsx.dir(o.addressOf("v.a$")); o.goto("s0"); break;\ncase "s0":',
