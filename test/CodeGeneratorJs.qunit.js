    ...
    QUnit.module("CodeGeneratorJs: Tests", function () {
        var allTests = {
            ...
            "fill, fix, fn, for, frame, fre": {
                ...
                "for a=5+b to -4 step -2.3": ' /* for() */ v.aR = o.vmAssign("aR", 5 + v.bR); v.aRStep = o.vmAssign("aR", -2.3); o.goto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > -4 || v.aRStep < 0 && v.aR < -4 || !v.aRStep && v.aR === -4) { o.goto("f0e"); break; }',
                "for a=b to c step d": ' /* for() */ v.aR = o.vmAssign("aR", v.bR); v.aREnd = o.vmAssign("aR", v.cR); v.aRStep = o.vmAssign("aR", v.dR); o.goto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > v.aREnd || v.aRStep < 0 && v.aR < v.aREnd || !v.aRStep && v.aR === v.aREnd) { o.goto("f0e"); break; }',
                "for a=b% to c%": ' /* for() */ v.aR = v.bI; v.aREnd = v.cI; o.goto("f0b"); break;\ncase "f0": v.aR += 1;\ncase "f0b": if (v.aR > v.aREnd) { o.goto("f0e"); break; }',
                "for a=1 to 1 step 0": ' /* for() */ v.aR = 1; o.goto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === 1) { o.goto("f0e"); break; }',
                "for a=b to c step s": ' /* for() */ v.aR = o.vmAssign("aR", v.bR); v.aREnd = o.vmAssign("aR", v.cR); v.aRStep = o.vmAssign("aR", v.sR); o.goto("f0b"); break;\ncase "f0": v.aR += v.aRStep;\ncase "f0b": if (v.aRStep > 0 && v.aR > v.aREnd || v.aRStep < 0 && v.aR < v.aREnd || !v.aRStep && v.aR === v.aREnd) { o.goto("f0e"); break; }',
                "for a=1 to 2 step 0": ' /* for() */ v.aR = 1; o.goto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === 2) { o.goto("f0e"); break; }',
                "for a=-1 to -2 step 0": ' /* for() */ v.aR = -1; o.goto("f0b"); break;\ncase "f0": v.aR += 0;\ncase "f0b": if (v.aR === -2) { o.goto("f0e"); break; }',
