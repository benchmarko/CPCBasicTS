...
//
define(["require", "exports", "../BasicLexer", "../BasicParser", "../CodeGeneratorToken", "./TestHelper", "./TestInput"], function (require, exports, BasicLexer_1, BasicParser_1, CodeGeneratorToken_1, TestHelper_1, TestInput_1) {
    "use strict";
    ...
    QUnit.module("CodeGeneratorToken: Tests", function (hooks) {
        hooks.before(function () {
            hooks.codeGeneratorToken = createCodeGeneratorToken();
        });
        ...
        function runTestsFor(category, tests, assert, results) {
            var codeGeneratorToken = hooks.codeGeneratorToken;
