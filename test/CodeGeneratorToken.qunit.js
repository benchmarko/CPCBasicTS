...
//
define(["require", "exports", "../BasicLexer", "../BasicParser", "../CodeGeneratorToken", "./TestHelper"], function (require, exports, BasicLexer_1, BasicParser_1, CodeGeneratorToken_1, TestHelper_1) {
    "use strict";
    ...
    QUnit.module("CodeGeneratorToken: Tests", function ( /* hooks */) {
        var allTests = {
            ...
            special: {
                ...
                "1 on error goto 2:mask ,\n2 rem": "0D,00,01,00,B2,9C,A0,1E,02,00,01,DF,00,06,00,02,00,C5,00,00,00",
                "|": "7C,00,80",
            ...
            "abs, after gosub, and, asc, atn, auto": {
                ...
                "10 after 2 gosub 10": "0B,00,0A,00,80,10,9F,1E,0A,00,00,00,00",
                "10 after 3,1 gosub 10": "0D,00,0A,00,80,11,2C,0F,9F,1E,0A,00,00,00,00",
            ...
            "call, cat, chain, chain merge, chr$, cint, clg, closein, closeout, cls, cont, copychr$, cos, creal, cursor": {
                ...
                'chain "f4" , 10+3, delete 100-200': "85,20,22,66,34,22,2C,19,0A,F4,11,2C,1E,64,00,F5,1E,C8,00",
                'chain "f5" , , delete 100-200': "85,20,22,66,35,22,2C,2C,1E,64,00,F5,1E,C8,00",
            ...
            "edit, ei, else, end, ent, env, eof, erase, erl, err, error, every gosub, exp": {
                ...
                "10 every 50 gosub 10": "0C,00,0A,00,9D,19,32,9F,1E,0A,00,00,00,00",
                "10 every 25.2,1 gosub 10": "12,00,0A,00,9D,1F,9A,99,99,49,85,2C,0F,9F,1E,0A,00,00,00,00",
                "10 every 10+a,b gosub 10": "16,00,0A,00,9D,19,0A,F4,0D,00,00,E1,2C,0D,00,00,E2,9F,1E,0A,00,00,00,00",
            ...
            "fill, fix, fn, for, frame, fre": {
                ...
                "for a=b to c step d": "9E,0D,00,00,E1,EF,0D,00,00,E2,EC,0D,00,00,E3,E6,0D,00,00,E4",
                "for a=b% to c%": "9E,0D,00,00,E1,EF,02,00,00,E2,EC,02,00,00,E3",
                "for a=1 to 1 step 0": "9E,0D,00,00,E1,EF,0F,EC,0F,E6,0E",
                "for a=b to c step s": "9E,0D,00,00,E1,EF,0D,00,00,E2,EC,0D,00,00,E3,E6,0D,00,00,F3",
                "for a=1 to 2 step 0": "9E,0D,00,00,E1,EF,0F,EC,10,E6,0E",
                "for a=-1 to -2 step 0": "9E,0D,00,00,E1,EF,F5,0F,EC,F5,10,E6,0E",
                "1 for a$=1 to 2": "0E,00,01,00,9E,03,00,00,E1,EF,0F,EC,10,00,00,00",
                "defint a:for abc=1 to 10 step 3:next abc": "8E,20,61,01,9E,0D,00,00,61,62,E3,EF,0F,EC,19,0A,E6,11,01,B0,20,0D,00,00,61,62,E3",
                "defstr a:for abc=1 to 10 step 3:next abc": "90,20,61,01,9E,0D,00,00,61,62,E3,EF,0F,EC,19,0A,E6,11,01,B0,20,0D,00,00,61,62,E3",
                "for a=b to c step s:defint a-b:a=0:defreal a:next": "9E,0D,00,00,E1,EF,0D,00,00,E2,EC,0D,00,00,E3,E6,0D,00,00,F3,01,8E,20,61,2D,62,01,0D,00,00,E1,EF,0E,01,8F,20,61,01,B0",
                "frame ": "E0",
            ...
            "if, ink, inkey, inkey$, inp, input, instr, int": {
                "10 if a=1 then goto 10": "12,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,A0,20,1E,0A,00,00,00,00",
                "10 if a=1 then 10": "10,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,1E,0A,00,00,00,00",
                "10 if a=1 goto 10": "12,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,A0,20,1E,0A,00,00,00,00",
                "10 if a=1 then a=a+1:goto 10": "1E,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,0D,00,00,E1,EF,0D,00,00,E1,F4,0F,01,A0,20,1E,0A,00,00,00,00",
                "10 if a=1 then gosub 10": "12,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,9F,20,1E,0A,00,00,00,00",
                "10 if a=1 then 10:a=never1": "1F,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,1E,0A,00,01,0D,00,00,E1,EF,0D,00,00,6E,65,76,65,72,B1,00,00,00",
                "10 if a=1 then 10 else 20\n20 rem": "15,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,1E,0A,00,01,97,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 if a=1 then 10 else goto 20\n20 rem": "17,00,0A,00,A1,0D,00,00,E1,EF,0F,EB,1E,0A,00,01,97,A0,20,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 if a=b+5*c then a=a+1: goto 10 else a=a-1:goto 20\n20 rem": "3B,00,0A,00,A1,0D,00,00,E1,EF,0D,00,00,E2,F4,13,F6,0D,00,00,E3,EB,0D,00,00,E1,EF,0D,00,00,E1,F4,0F,01,A0,20,1E,0A,00,01,97,0D,00,00,E1,EF,0D,00,00,E1,F5,0F,01,A0,20,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 if a%<>3 then 10": "10,00,0A,00,A1,02,00,00,E1,F2,11,EB,1E,0A,00,00,00,00",
                '10 if a$<>"3" then 10': "12,00,0A,00,A1,03,00,00,E1,F2,22,33,22,EB,1E,0A,00,00,00,00",
            ...
            "new, next, not": {
                "new ": "B1",
                "for a=1 to 2: next ": "9E,0D,00,00,E1,EF,0F,EC,10,01,B0",
                "for i=1 to 2: next i": "9E,0D,00,00,E9,EF,0F,EC,10,01,B0,20,0D,00,00,E9",
                "for j=1 to 2:for i=3 to 4: next i,j": "9E,0D,00,00,EA,EF,0F,EC,10,01,9E,0D,00,00,E9,EF,11,EC,12,01,B0,20,0D,00,00,E9,2C,0D,00,00,EA",
            ...
            "on break ..., on error goto, on gosub, on goto, on sq gosub, openin, openout, or, origin, out": {
                "on break cont": "B3,8B",
                "10 on break gosub 10": "0B,00,0A,00,B3,9F,20,1E,0A,00,00,00,00",
                "on break stop": "B3,CE",
                "10 on error goto 0": "06,00,0A,00,B4,00,00,00",
                "10 on error goto 10": "0B,00,0A,00,B2,9C,A0,1E,0A,00,00,00,00",
                "10 on 1 gosub 10": "0B,00,0A,00,B2,0F,9F,1E,0A,00,00,00,00",
                "10 on x gosub 10,20\n20 rem": "12,00,0A,00,B2,0D,00,00,F8,9F,1E,0A,00,2C,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 on x+1 gosub 10,20,20\n20 rem": "18,00,0A,00,B2,0D,00,00,F8,F4,0F,9F,1E,0A,00,2C,1E,14,00,2C,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 on 1 goto 10": "0B,00,0A,00,B2,0F,A0,1E,0A,00,00,00,00",
                "10 on x goto 10,20\n20 rem": "12,00,0A,00,B2,0D,00,00,F8,A0,1E,0A,00,2C,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 on x+1 goto 10,20,20\n20 rem": "18,00,0A,00,B2,0D,00,00,F8,F4,0F,A0,1E,0A,00,2C,1E,14,00,2C,1E,14,00,00,06,00,14,00,C5,00,00,00",
                "10 on sq(1) gosub 10": "0D,00,0A,00,B5,28,0F,29,9F,1E,0A,00,00,00,00",
                "10 on sq(channel) gosub 10": "16,00,0A,00,B5,28,0D,00,00,63,68,61,6E,6E,65,EC,29,9F,1E,0A,00,00,00,00",
            ...
            "paper, peek, pen, pi, plot, plotr, poke, pos, print": {
                ...
                'print using "##.##";-1.2': "BF,20,ED,22,23,23,2E,23,23,22,3B,F5,1F,9A,99,99,19,81",
                'print using"### ########";a,b': "BF,20,ED,22,23,23,23,20,23,23,23,23,23,23,23,23,22,3B,0D,00,00,E1,2C,0D,00,00,E2",
                'print using "\\   \\";"n1";"n2";" xx3";': "BF,20,ED,22,5C,20,20,20,5C,22,3B,22,6E,31,22,2C,22,6E,32,22,2C,22,20,78,78,33,22,3B",
                'print using "!";"a1";"a2";': "BF,20,ED,22,21,22,3B,22,61,31,22,2C,22,61,32,22,3B",
                'print using "&";"a1";"a2";': "BF,20,ED,22,26,22,3B,22,61,31,22,2C,22,61,32,22,3B",
            ...
            "wait, wend, while, width, window, window swap, write": {
                ...
                "while a=10: wend ": "D6,20,0D,00,00,E1,EF,19,0A,01,D5",
            ...
            keepSpaces: {
                ' 1  chain   merge  "f5"': "0F,00,01,00,20,20,85,AB,20,20,22,66,35,22,00,00,00",
                ' 1  def   fn  a$ = "abc"': "17,00,01,00,20,20,8D,20,E4,20,20,20,03,00,00,E1,EF,22,61,62,63,22,00,00,00",
                " 1  for   i   =   1   to  10   step  2": "26,00,01,00,20,20,9E,20,20,20,0D,00,00,E9,20,20,20,EF,20,20,20,0F,20,20,20,EC,20,20,19,0A,20,20,20,E6,20,20,10,00,00,00",
                " 1  if    a  =  1     then  1     else    goto  1": "23,00,01,00,20,20,A1,20,20,0D,00,00,E1,EF,0F,EB,20,20,1E,01,00,01,97,20,20,20,20,A0,20,20,20,1E,01,00,00,00,00",
                " 1  line   input  a$": "10,00,01,00,20,20,A6,A3,20,20,20,03,00,00,E1,00,00,00",
                " 1  on  break   cont": "09,00,01,00,20,20,B3,8B,00,00,00",
                " 1  on  break   gosub   1 ": "10,00,01,00,20,20,B3,9F,20,20,20,20,1E,01,00,00,00,00",
                " 1  on  break   stop": "09,00,01,00,20,20,B3,CE,00,00,00",
                " 1  on  error   goto   1 ": "10,00,01,00,20,20,B2,9C,A0,20,20,20,1E,01,00,00,00,00",
                " 1  on  x  gosub   1  ,  2\n2  rem": "1D,00,01,00,20,20,B2,20,20,0D,00,00,F8,20,20,9F,20,20,20,1E,01,00,2C,20,20,1E,02,00,00,08,00,02,00,20,20,C5,00,00,00",
                " 1  on  x  goto   1  ,  2\n2  rem": "1D,00,01,00,20,20,B2,20,20,0D,00,00,F8,20,20,A0,20,20,20,1E,01,00,2C,20,20,1E,02,00,00,08,00,02,00,20,20,C5,00,00,00",
                ' 1   print   using    "####" ;  ri  ;': "24,00,01,00,20,20,20,BF,20,20,20,20,ED,20,20,20,20,20,22,23,23,23,23,22,3B,20,20,0D,00,00,72,E9,20,20,3B,00,00,00",
                " 1  window   swap  1,0": "0F,00,01,00,20,20,D8,E7,20,20,20,0F,2C,0E,00,00,00",
                ...
                "a = (((3+2))*((3-7)))": "0D,00,00,E1,EF,28,28,28,11,F4,10,29,29,F6,28,28,11,F5,15,29,29,29"
            },
            PRG: {
