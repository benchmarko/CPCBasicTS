...
QUnit.module("CodeGeneratorToken: Tests", function (/* hooks */) {
	const mAllTests: AllTestsType = {
		...
		"data, dec$, def fn, defint, defreal, defstr, deg, delete, derr, di, dim, draw, drawr": {
			...
			"data \"item1\",\" item2\",\"item3 \"": "8C,20,69,74,65,6D,31,2C,22,20,69,74,65,6D,32,22,2C,22,69,74,65,6D,33,20,22",
		...
		"fill, fix, fn, for, frame, fre": {
			...
			"x=fnclk": "0D,00,00,F8,EF,E4,0D,00,00,66,6E,63,6C,EB",
			"x=fnclk(a)": "0D,00,00,F8,EF,E4,0D,00,00,66,6E,63,6C,EB,28,0D,00,00,E1,29",
			"x=fnclk(a,b)": "0D,00,00,F8,EF,E4,0D,00,00,66,6E,63,6C,EB,28,0D,00,00,E1,2C,0D,00,00,E2,29",
			"x$=fnclk$(a$,b$)": "03,00,00,F8,EF,E4,03,00,00,66,6E,63,6C,EB,28,03,00,00,E1,2C,03,00,00,E2,29",
			"x=fn clk": "0D,00,00,F8,EF,E4,20,0D,00,00,66,6E,63,6C,EB",
			"x=fn clk(a)": "0D,00,00,F8,EF,E4,20,0D,00,00,66,6E,63,6C,EB,28,0D,00,00,E1,29",
			"x=fn clk(a,b)": "0D,00,00,F8,EF,E4,20,0D,00,00,66,6E,63,6C,EB,28,0D,00,00,E1,2C,0D,00,00,E2,29",
			"x$=fn clk$(a$,b$)": "03,00,00,F8,EF,E4,20,03,00,00,66,6E,63,6C,EB,28,03,00,00,E1,2C,03,00,00,E2,29",
		...
		"rad, randomize, read, release, rem, remain, renum, restore, resume, return, right$, rnd, round, run": {
			...
			"'": "C0",
			"'comment until EOL": "C0,63,6F,6D,6D,65,6E,74,20,75,6E,74,69,6C,20,45,4F,4C",
