...
QUnit.module("BasicTokenizer:decode: Tests", function () {
	const mAllTests: AllTestsType = { // eslint-disable-line vars-on-top
		...
		PRG: { // tests marked with "L" are full programs with line numbers
