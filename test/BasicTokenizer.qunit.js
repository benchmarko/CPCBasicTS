...
define(["require", "exports", "../BasicTokenizer", "./TestHelper"], function (require, exports, BasicTokenizer_1, TestHelper_1) {
    ...
    function createBasicTokenizer() {
        return new BasicTokenizer_1.BasicTokenizer();
    }
    ...
    QUnit.module("BasicTokenizer:decode: More Tests", function (hooks) {
        ...
        function runTestsForMore(category, tests, assert, results) {
            var basicTokenizer = hooks.basicTokenizer;
            for (var key in tests) {
                if (tests.hasOwnProperty(key)) {
                    var expected = tests[key], result = runSingleTest(basicTokenizer, key);
        ...
        TestHelper_1.TestHelper.generateAllTests(moreTests, runTestsForMore, hooks);
    });
});
